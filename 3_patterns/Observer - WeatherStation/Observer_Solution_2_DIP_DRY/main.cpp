...
int main(int argc, char *argv[])
{
    ...
    tempSensor->attachView(chartView);
    humiditySensor->attachView(chartView);

    LineView* lineView = new LineView(tempSensor, humiditySensor);
    tempSensor->attachView(lineView);
    humiditySensor->attachView(lineView);

    BarView* barView = new BarView(tempSensor, humiditySensor);
    tempSensor->attachView(barView);
    humiditySensor->attachView(barView);
